...
async function main() {
  console.log('Starting manual seed for leaflets and brochures...');
  ...
  if (existingLeaflets > 5) {
    console.log(`Found ${existingLeaflets} existing leaflet products. Skipping seeding to avoid duplication.`);
    process.exit(0);
  }
