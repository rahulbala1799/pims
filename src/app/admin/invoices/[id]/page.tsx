...
export default function InvoiceDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleDeleteInvoice = async () => {
    if (!confirm('Are you sure you want to cancel this invoice? This action cannot be undone. Any associated jobs will be retained but their revenue will be set to 0.')) {
      return;
    }
