...
export default function CostCalculator() {
  ...
  // Calculate margin from a given price
  const calculateMarginFromPrice = (price: number) => {
  ...
  const handleCustomPriceChange = (value: string) => {
    ...
    const margin = calculateMarginFromPrice(price);
  ...
  const handleApplyCustomPrice = () => {
    if (customPrice === '' || parseFloat(customPrice) <= 0) return;
        ...
        <>
          ...
          <div className="bg-white rounded-md shadow p-4 mb-6">
            ...
            <div className="mt-6 p-4 border border-dashed border-indigo-300 rounded-md bg-indigo-50">
              <h4 className="font-medium text-indigo-800 mb-2">Enter Custom Price</h4>
              <div className="flex items-end space-x-4">
                <div className="flex-grow">
                  <label htmlFor="custom-price" className="block text-sm font-medium text-indigo-700 mb-1">
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 p-3 border border-indigo-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-lg shadow-sm"
                      value={customPrice}
                ...
                <button
                  ...
                  className="px-4 py-3 border border-transparent rounded-md font-medium shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Apply
                </button>
              </div>
              {customMargin !== null && (
                <div className="mt-2 text-indigo-700">
                  This price gives a margin of <span className="font-semibold">{customMargin.toFixed(2)}%</span>
                </div>
              )}
            </div>
            
            {(selectedMargin !== null || customMargin !== null) && (
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-green-700">
                      {selectedMargin !== null 
                        ? `${selectedMargin}% Gross Margin` 
                        : `${customMargin?.toFixed(2)}% Gross Margin`}
                    </p>
                  </div>
