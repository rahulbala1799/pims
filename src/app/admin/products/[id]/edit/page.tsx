    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          finishOptions: product.finishOptions ? product.finishOptions.join(', ') : '',
          minOrderQuantity: product.minOrderQuantity.toString(),
          leadTime: product.leadTime ? product.leadTime.toString() : '',
        ...
        setSelectedClass(product.productClass);
      } catch (err) {
        ...
        <div className="space-y-8 divide-y divide-gray-200">
          ...
          <div className="pt-8">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Update the pricing and quantity information.
              </p>
            </div>
          ...
          <div className="pt-8">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Update additional details about the product.
              </p>
            </div>
