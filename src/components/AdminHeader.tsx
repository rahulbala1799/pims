...
export default function AdminHeader() {
  ...
  const navigationItems = [
    ...
    { path: '/admin/hours', label: 'Hours', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    { path: '/admin/metrics', label: 'Metrics', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  return (
    <div>
      ...
      {/* Sidebar for desktop */}
      <div className={`fixed inset-0 flex z-40 lg:z-auto ${isSidebarOpen ? 'visible' : 'lg:visible invisible'}`}>
        {/* Overlay */}
        <div 
          className={`fixed inset-0 bg-gray-600 bg-opacity-75 transition-opacity lg:hidden ${isSidebarOpen ? 'opacity-100 ease-out duration-300' : 'opacity-0 ease-in duration-200'}`} 
        ...
        {/* Sidebar */}
        <div className={`
          relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white shadow-xl transition transform 
          lg:relative lg:translate-x-0 lg:max-w-xs
          ${isSidebarOpen ? 'translate-x-0 ease-out duration-300' : '-translate-x-full ease-in duration-200 lg:translate-x-0'}
        `}>
        ...
        {/* Empty area to enable closing the sidebar by clicking outside on mobile */}
